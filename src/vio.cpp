...
void VIOManager::initializeVIO()
{
  ...
  if(colmap_output_en)
  {
    pinhole_cam = std::dynamic_pointer_cast<vk::PinholeCamera>(cam);
...
void VIOManager::getWarpMatrixAffineHomography(const std::shared_ptr<vk::AbstractCamera> &cam, const V2D &px_ref, const V3D &xyz_ref, const V3D &normal_ref,
...
void VIOManager::getWarpMatrixAffine(const std::shared_ptr<vk::AbstractCamera> &cam, const Vector2d &px_ref, const Vector3d &f_ref, const double depth_ref,
